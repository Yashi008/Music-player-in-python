...
rootpath= "C:\\Users\KIIT\Desktop\songs"
pattern= "*.mp3"
...
stopButton.pack(pady=15, anchor='center',in_= top, side='left')

playButton= tk.Button(canvas, text= "Play", image=play_img, bg= 'black', borderwidth=0, command=select)
playButton.pack(pady=15, anchor='center',in_= top, side='left')

pauseButton= tk.Button(canvas, text= "Pause", image=pause_img, bg= 'black', borderwidth=0, command=pause_song)
pauseButton.pack(pady=15, anchor='center',in_= top, side='left')

nextButton= tk.Button(canvas, text= "Next", image=next_img, bg= 'black', borderwidth=0, command=play_next)
nextButton.pack(pady=15, anchor='center',in_= top, side='left')
